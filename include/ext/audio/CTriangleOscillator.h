#ifndef HEADER_B0E82F2B569798CD
#define HEADER_B0E82F2B569798CD
...
namespace irr
{
	...
	class CTriangleOscillator : public IFunction<T>
	{
		...
		public:
			...
			CTriangleOscillator( const T& freq = (T)440, const T& phase = (T)0, const T& amp = (T)1)
			{
				setFrequency( freq );
				setPhase( phase );
				setAmplitude( amp );
...
#endif // __IRR_C_TRIANGLE_OSCILLATOR_H__
